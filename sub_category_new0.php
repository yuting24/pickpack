...
$beauty = $_GET["beauty"];
$result0 = mysqli_query($con,"Select * From article where kind ='1'&& small_kind='$beauty' group by product_name order by time desc") or die("Error");
session_start();
?>
...
<body style="background-image: url('img/back.png')!important;">
  ...
  <div class="" style="margin-top: 13%; margin-bottom: 3%;">
    <h2 class="text-center active" onclick="productType('all')">美妝</h2>
      <ul class="nav justify-content-center" id="myTab" role="tablist">
    <?php $small=array("底妝","眼妝","唇妝");
  for($i=0;$i<count($small);$i++){
  ?>
  
  
        <li class="nav-item" role="presentation">
  <a href="sub_category_new0.php?beauty=<?php echo $i;?>"class="nav-link"><h5><?php echo $small[$i];?></h5></a>
        </li>
      <?php }?>
      </ul>
  </div>

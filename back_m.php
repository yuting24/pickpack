...
$result = mysqli_query($con,"Select * From member") or die("Error");
?>
<!DOCTYPE html>
<html>
<head>
...
<div id="main">
 ...
 <?php 
	  ...
	  ?>
 <button style="float:right;width:100px;height:30px;margin:5px;"onclick="deletem('<?php echo $row['member_id'] ?>')" type="button" >註銷此會員</button>
 <hr>
 <?php } ?>
 </div>

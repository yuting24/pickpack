...
$result = mysqli_query($con,"Select * From article where kind ='4' group by product_name order by time desc") or die("Error");
session_start();
?>
<!DOCTYPE html>
<html lang="en">
...
<body style="background-image: url('img/back.png')!important;">
  ...
  <div class="" style="margin-top: 13%; margin-bottom: 3%;">
    <h2 class="text-center active" onclick="productType('all')">旅遊</h2>
      <ul class="nav justify-content-center" id="myTab" role="tablist">
	  <?php $small=array("景點","住宿");
	for($i=0;$i<count($small);$i++){
	?>
	
	
        <li class="nav-item" role="presentation">
	<a href="sub02_01.php?beauty=<?php echo $i;?>"class="nav-link"><h5><?php echo $small[$i];?></h5></a>
        </li>
			<?php }?>
      </ul>
  </div>

...
if($_POST['pname']!=''){
 $pname=$_POST['pname'];
$result = mysqli_query($con,"Select * From article where product_name like '%$pname%' order by time desc") or die("Error");

}
else{
$result = mysqli_query($con,"Select * From article order by time desc") or die("Error"); 
}
...
<div class="search-container">
  ...
  <div class="" style="margin-top: 13%; margin-bottom: 3%;">
     <h2 class="text-center active" onclick="productType('all')">搜尋結果</h2>
  </div>
  
  <div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="allitem" role="tabpanel" aria-label ledby="allitem-tab">
      <div class="row w-75 container" style="margin-left:18%;">
    <?php 
    while ($row = mysqli_fetch_array ($result)){?>
        <div class=" mb-5 col-3 item <?php echo $row['small_kind'] ?>">
            <div class="card" style="width: 12rem;">
              ...
              <div class="card-body px-1">
                 <h5 class="card-title text-center"><a href="ind.php?pid=<?php echo $row['article_id']?>"><?php echo $row['title']?></a></h5>

...
<body style="background-image: url('img/back.png')!important;">
 <div class="header">
  ...
  <div class="wlect">
  <form name="form1" method="post" action="carticleadd.php" accept-charset="utf-8" enctype="multipart/form-data">
  ...
  <div class="ty">產品名稱:<input type="text" name="product_name" class="pn" placeholder="請輸入產品名稱"></textarea></div>
   <div class="ty">表單網址:<input type="text" name="google_name" class="pn" placeholder="請輸入表單網址"></textarea></div>
    <div class="ty">選擇分類:
...
var inner="";
 ...
 changeKind(document.getElementById("kind-list").selectedIndex);
    ...
    <textarea class="cont" name="content" placeholder="產品介紹....."></textarea>
